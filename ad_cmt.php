...
function ThongBao(){
return confirm("Bạn có chắc muốn xóa góp ý này?");	
}
function ThongBao2(){
   ...
   <div class="panel panel-default panel-table"> 
    <div class="panel-heading"> 
     <div class="row"> 
      <div class="col col-xs-6"> 
       <h3 class="panel-title" align="center"><b>Quản lí góp ý của khách hàng</b></h3> 
      </div> 
     </div> 
    </div> 
    <div class="panel-body"> 
     <table class="table table-striped table-bordered table-list"> 
      <thead> 
       <tr> 
       <th width="30px"><a><em class="fa fa-cog"></em></a></th>
	...
	?>
      ...
      <tr> 
      <td align="center">
       <a href="deletecmt.php?id=<?=$id?>" class="btn btn-danger" onclick="return ThongBao()"><em class="fa fa-trash"></em></a>
       </td>

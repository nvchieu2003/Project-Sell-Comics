...
function ThongBao(){
return confirm("Bạn có chắc muốn xóa đăng xuất?");	
}
</script>
</head>
<body>
...
<nav class="navbar navbar-expand-lg bg-light" style="padding:20px 100px; margin-top:280px">
    ...
    <div class="btn-groupS" role="group">
        <a href="afterlogin.php"><button type="button" class="btn btn-outline-secondary">1</button></a>
        <button type="button" class="btn btn-outline-secondary" style="background-color:#999; color:#fff">2</button>

...
<header>
    <div class="container1">
        ...
        <br>
        <a href="login.php" style="margin-left:1140px"><button type="button" class="btn btn-warning"><i class="uil uil-shopping-bag"></i> Giỏ hàng</button></a>
...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true" style="margin-left:160px">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="image/83.jpg" height="400px" width="600px" class="d-block w-100" alt="">
    </div>
    <div class="carousel-item">
      <img src="image/vd.jpg" height="400px" class="d-block w-100" alt="">
    </div>
    <div class="carousel-item">
      <img src="image/banner12.jpg" height="400px" class="d-block w-100" alt="">
    </div>
  </div>

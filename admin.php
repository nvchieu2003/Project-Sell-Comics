...
<br>
<a href="ad_report.php"><button type="button" style="float:right; margin-right: 150px ; background-color:#CCCC33; color: #009966" class="btn btn-secondary"><b> Xem báo cáo của người dùng !</b></button></a>
<a href="ad_cmt.php"><button type="button" style="float:right; margin-right: 0px ; background-color:#FFCCCC; color: #009966" class="btn btn-secondary"><b> Quản lí góp ý khách hàng</b></button></a>
</h1>  
  ...
  <div class="col-md-10 col-md-offset-1"> 
   <div class="panel panel-default panel-table"> 
    <div class="panel-heading"> 
     <div class="row"> 
      ...
      <div class="col col-xs-6 text-right"> 
       <a href="addsp.php"><button type="button" class="btn btn-sm btn-primary btn-create">Thêm mới</button></a>
      </div> 
     </div> 
    </div> 
	...
	?>
      <tbody>
      <tr> 
       <td align="center"><a href="fixsp.php?id=<?=$id?>" class="btn btn-default" ><em class="fa fa-pencil"></em></a>
       <a href="detelesp.php?id=<?=$id?>" class="btn btn-danger" onclick="return ThongBao()"><em class="fa fa-trash"></em></a>
       </td> 
...
?>
    ...
    <div class="panel-footer"> 
     <div class="row"> 
      <div class="col col-xs-4"><a href="index.php" style="font-size: 17px"> <i class="uil uil-corner-up-left-alt" ></i> Quay về trang chủ</a></div> 
